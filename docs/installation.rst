...
The sources for Shadow can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/karma0/shadow
.. _tarball: https://github.com/karma0/shadow/tarball/master
